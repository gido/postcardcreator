...
module.exports = function (client) {
    ...
    function usersPost(params, callback) {
        var requestParams = {
            url: '/users',
            method: 'POST',
            body: params,
    ...
    /**
     ...
     A nicer API whould be:
        client.users(1234).quota(); // return the quota of user id 1234
        client.users().quota();     // return the quota of the authenticated user
     */
    var resourceApi = {
        current: current,
        create: usersPost,
